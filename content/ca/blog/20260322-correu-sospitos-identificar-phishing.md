---
title: "He rebut un correu sospitós: és phishing i què haig de fer?"
author: "GuardianHubX"
...
description: "Aprèn a identificar un email de phishing, coneix els tipus d'atac (spear phishing, BEC, quishing) i quines accions prendre si has estat víctima. Guia pràctica."
cover:
  image: "uploads/identificar-phishing.webp"
  width: 1200
  height: 630
  alt: "Com identificar email de phishing i protegir-se dels atacs"
...
Aquesta tècnica de pressió temporal és un dels pilars de l'[enginyeria social](/ca/phishing-que-es-i-com-evitar/), que busca anul·lar el teu pensament crític.
...
<tr>
<td><strong>Phishing massiu</strong></td>
<td>Correus a milers de persones sense personalització</td>
<td><span class="risk-badge bajo">MITJÀ</span></td>
</tr>
<tr>
<td><strong>Spear phishing</strong></td>
<td>Atacs dirigits amb informació personalitzada sobre la víctima</td>
<td><span class="risk-badge alto">ALT</span></td>
</tr>
<tr>
...
<td>Suplantació de CEO demanant transferències urgents</td>
<td><span class="risk-badge critico">CRÍTIC</span></td>
</tr>
<tr>
<td><strong>Quishing</strong></td>
<td>Codis QR falsos que redirigeixen a pàgines de login fraudulentes</td>
<td><span class="risk-badge alto">ALT</span></td>
</tr>
<tr>
<td><strong>Vishing</strong></td>
<td>Phishing per telèfon usant enginyeria social</td>
<td><span class="risk-badge alto">ALT</span></td>
</tr>
<tr>
<td><strong>Smishing</strong></td>
<td>Phishing per SMS o WhatsApp</td>
<td><span class="risk-badge medio">MITJÀ-ALT</span></td>
</tr>
</table>
...
<i class="fas fa-times-circle icon-action error"></i> **No facis clic** — No obris enllaços ni descarreguis adjunts sense verificar abans

<i class="fas fa-check-circle icon-action success"></i> **Verifica el remitent** — Revisa el domini complet (no només el nom mostrat)

<i class="fas fa-phone icon-action info"></i> **Contacta directament** — Truca a l'empresa per telèfon (número de la seva web oficial, no del correu)

<i class="fas fa-exclamation-triangle icon-action warning"></i> **Reporta el correu** — Marca'l com phishing / spam en el teu client d'email; a empresa notifica a IT

<i class="fas fa-trash icon-action neutral"></i> **Elimina el correu** — Només després de reportar-lo, elimina'l de forma segura
...
<div class="defense-card critical">
<strong><i class="fas fa-flask"></i> Simulacions periòdiques</strong>
<p>Atacs falsos per avaluar i entrenar empleats que "cauen"</p>
<span class="priority-badge">CRÍTICA</span>
</div>

<div class="defense-card critical">
<strong><i class="fas fa-lock"></i> MFA obligatòria</strong>
<p>Autenticació multifactor en comptes crítics (email, financer, VPN)</p>
<span class="priority-badge">CRÍTICA</span>
</div>

<div class="defense-card high">
<strong><i class="fas fa-eye"></i> Monitorització d'accessos</strong>
<p>Detecta patrons inusuals (ubicacions noves, hores rares, falles múltiples)</p>
<span class="priority-badge">ALTA</span>
</div>

<div class="defense-card high">
<strong><i class="fas fa-envelope"></i> Filtres de correu</strong>
<p>Detecten dominis falsos, URLs malicioses i patrons de phishing</p>
<span class="priority-badge">ALTA</span>
</div>
...
<div class="defense-card high">
<strong><i class="fas fa-network-wired"></i> Segmentació de xarxa</strong>
<p>Limita accés lateral si un dispositiu és compromès</p>
<span class="priority-badge">ALTA</span>
</div>
...
[Coneix com protegim la teva empresa →](/ca/#contact)
