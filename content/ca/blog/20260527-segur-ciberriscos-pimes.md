---
title: "Segur de ciberriscos: què cobre i quant costa per a pimes"
author: "GuardianHubX"
...
tags:
  ...
  - normativa
  - bones-pràctiques
description: "Guia sobre assegurances de ciberriscos per a pimes: quines cobertures inclouen, quines exclou, requisits d'asseguradores i com contractar-ho."
cover:
  image: "/images/blog/2026/seguro-ciberriesgos.webp"
  width: 451
  height: 301
  alt: "Segur de ciberriscos per a empreses: cobertures i cost"
  caption: "Font: GuardianHubX"
relatedProduct: "guardianaradar"
featured: false
keywords:
  - "segur ciberriscos pimes"
  - "cyber insurance espanya"
  - "cobertura ciberatac"
  - "cost ciberassegurança empresa"
...
<tr>
<th>Cobertura</th>
<th>Què sol incloure</th>
<th>Què convé revisar</th>
</tr>
</thead>
<tbody>
<tr>
<td><strong>Resposta a l'incident</strong></td>
<td>Forense, suport, restauració, assistència 24/7</td>
<td>Temps de resposta, proveïdors inclosos</td>
</tr>
<tr>
<td><strong>Bretxa de dades</strong></td>
<td>Responsabilitat, notificació, defensa</td>
<td>Límits, despeses inclosos, dades afectades</td>
</tr>
<tr>
<td><strong>Interrupció del negoci</strong></td>
<td>Pèrdua de beneficis o despeses extra</td>
<td>Manca, franquícia temporal, mètode de càlcul</td>
</tr>
<tr>
<td><strong>Ransomware / extorsió</strong></td>
<td>Gestió de l'incident i despeses associats</td>
<td>Sublímits, condicions, exclusions</td>
</tr>
<tr>
<td><strong>Frau per enginyeria social</strong></td>
<td>Transferències o pagaments manipulats</td>
<td>Si està inclòs o és opcional</td>
</tr>
<tr>
<td><strong>Serveis preventius</strong></td>
<td>Escanig, formació, suport bàsic</td>
<td>Si és cortesia, opcional o contractual</td>
</tr>
</tbody>
</table>
...
<i class="fas fa-check-circle icon-action success"></i> **Autenticació multifactor** en accessos crítics

<i class="fas fa-check-circle icon-action success"></i> **Còpies de seguretat** offline o immutables

<i class="fas fa-check-circle icon-action success"></i> **Política de parcheo** formalitzada

<i class="fas fa-check-circle icon-action success"></i> **Control d'accessos** documentat

<i class="fas fa-check-circle icon-action success"></i> **Formació antifraude** periòdica

<i class="fas fa-check-circle icon-action success"></i> **EDR o protecció del endpoint** activa

<i class="fas fa-check-circle icon-action success"></i> **Pla de resposta a incidents** escrit
