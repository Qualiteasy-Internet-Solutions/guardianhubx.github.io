---
title: "GuardianRadar | Ciberseguretat per a Autònoms i Pimes"
...
ogImageAlt: "GuardianRadar: Vigilància digital 24/7 per autònoms i Pimes sense instal·lacions"
slug: "guardianradar"
layout: "radar"
...
popup:
  ...
  label_name: "El teu Nom"
  label_email: "El teu Email"
  label_plan: "Quin pla necessites?"
  btn_text: "Demanar Activació Ara"
  legal: "En fer clic, s'obrirà el teu WhatsApp per enviar-nos aquestes dades automàticament."  
  wa_intro: "HOLA! VULL ACTIVAR GUARDIAN RADAR"
  wa_ending: "Espero instruccions per al pagament."  
  plans:
...
<div class="pricing-box">
  <div class="pricing-header">
    <h3>Oferta de Llançament</h3>
    <p>Activa avui la teva Vigilància Digital.</p>
  </div>
  ...
  <p class="pricing-note">*Preu bloquejat per als primers 50 clients*</p>
  ...
  <div style="background-color: #e9ecef; padding: 15px; border-radius: 8px; margin: 20px 0; text-align: left; font-size: 0.95rem; border-left: 4px solid #0d2c56;">
    <strong>🧪 Extra Tècnic (Opcional):</strong> Vols saber si el teu web està mal configurat? Sol·licita un <strong>Informe Tècnic del teu domini</strong> (DNS, SSL, configuracions exposades) per un pagament únic de <strong>100 €</strong>.
  </div>
  ...
  <p class="money-back-guarantee">🔒 Pagament segur. Sense permanència. Garantia de devolució 15 dies.</p>
</div>