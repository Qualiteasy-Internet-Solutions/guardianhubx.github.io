...
ogImageAlt: "GuardianRadar: Vigilancia digital 24/7 para autónomos y Pymes sin instalaciones"
...
intro:
  - title: "Te avisamos antes de que sea un problema"
    description: "Si algo le pasa a tu email o web, tienes que saberlo. Hemos diseñado este servicio de **ciberseguridad para autónomos y Pymes** que no quieren complicaciones, pero sí protegerse. Vigilancia digital simple y efectiva."
...
popup:
  ...
  label_plan: "¿Qué plan necesitas?"
  btn_text: "Pedir Activación Ahora"
  legal: "Al hacer clic, se abrirá tu WhatsApp para enviarnos estos datos automáticamente."  
  wa_intro: "HOLA! QUIERO ACTIVAR GUARDIAN RADAR"
  wa_ending: "Espero instrucciones para el pago."  
  plans:
...
<div class="features-grid">
  ...
  <div class="feature-card">
    ...
    <div class="feature-content">
      <div class="h5 fw-bold">Cuentas y Dominio</div>
  ...
  <div class="feature-card">
    ...
    <div class="feature-content">
      <div class="h5 fw-bold">Contraseñas</div>
  ...
  <div class="feature-card">
    ...
    <div class="feature-content">
      <div class="h5 fw-bold">Datos Críticos</div>
  ...
  <div class="feature-card">
    ...
    <div class="feature-content">
      <div class="h5 fw-bold">Alertas de Fraude Masivo</div>
  ...
  <div class="feature-card">
    ...
    <div class="feature-content">
      <div class="h5 fw-bold">Alertas Inmediatas</div>
  ...
  <div class="feature-card feature-card-whatsapp">
    ...
    <div class="feature-content">
      <div class="h5 fw-bold">Soporte Humano</div>
...
<div class="process-container">
  ...
  <div class="process-step">
    ...
    <div class="h5 fw-bold">Tu "Botón del Pánico"</div>
    <p>¿Un email raro? Mándanos la foto por WhatsApp y te decimos si es seguro.</p>
  </div>

  <div class="process-step">
    <div class="step-number">4</div>
    <div class="h5 fw-bold">Alerta y Solución</div>
...
<div class="pricing-box">
  <div class="pricing-header">
    ...
    <p>Activa hoy tu Vigilancia Digital.</p>
  </div>
  ...
  <table class="styled-table">
    <thead>
      <tr>
        ...
        <th>Pyme / Empresa <small>(Hasta 10)</small></th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td>Precio Habitual</td>
        <td class="crossed">29,99 €/mes</td>
        <td class="crossed">49,99 €/mes</td>
      </tr>
      <tr class="offer-row">
        <td><strong>OFERTA</strong></td>
        <td><strong>9,99 € / mes</strong></td>
        <td><strong>29,99 € / mes</strong></td>
      </tr>
    </tbody>
  </table>
  <p class="pricing-note">*Precio bloqueado para los primeros 50 clientes*</p>
  ...
  <div style="background-color: #e9ecef; padding: 15px; border-radius: 8px; margin: 20px 0; text-align: left; font-size: 0.95rem; border-left: 4px solid #0d2c56;">
    <strong>🧪 Extra Técnico (Opcional):</strong> ¿Quieres saber si tu web está mal configurada? Solicita un <strong>Informe Técnico de tu dominio</strong> (DNS, SSL, configuraciones expuestas) por un pago único de <strong>100 €</strong>.
  </div>

  <div class="cta-container">  
   <a href="/es/guardianradar-config" class="btn-action btn-primary-action" style="text-decoration: none; display: inline-flex; align-items: center; justify-content: center; cursor: pointer; border: none;">
  ...
  <p class="money-back-guarantee">🔒 Pago seguro. Sin permanencia. Garantía de devolución 15 días.</p>
</div>