$(document).ready(function () {
  ...
  const translations = {
    es: {
      ...
      "solution-prey-desc": "Protege, rastrea y recupera tus portátiles robados o extraviados aunque no tengan GPS.",
      "solution-qualiteasy-desc" : "Gestión documental ISO, control de riesgos y procesos para empresas que buscan certificaciones y eficiencia.",
      ...
      "miembro-desc": "GuardianHubX es miembro de:",
      "thanks": "Gracias, hemos recibido vuestro mensaje, nos pondemos en contacto en breve.",
      "goback": "Volver a la página inicial",
      "thanks-test": "¡Gracias por rellenar el formulario! Recibirás la información en tu correo en un plazo de 5 minutos.",
      "thanks-test-info": "Si no la ves, revisa tu carpeta de spam o escríbenos a info@guardianhubx.com",
    ...
    en: {
      ...
      "solution-prey-desc": "Protect, track, and recover your stolen or lost laptops—even without GPS.",
      "solution-qualiteasy-desc" : "ISO document management, risk control, and process optimization for companies aiming for certification and efficiency.",
      ...
      "miembro-desc": "GuardianHubX, member of",
      "thanks": "Thanks, we received your message. We will contact you soon.",
      "goback": "Go back to the homepage",
      "thanks-test": "Thank you for filling the form! You'll receive the information in your inbox within 5 minutes.",
